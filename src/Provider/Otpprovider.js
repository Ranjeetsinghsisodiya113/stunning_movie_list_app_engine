                  ...
                  <TouchableOpacity activeOpacity={1} onPress={() => { this.setState({ modalVisible: true }) }} >
                   ...
                   {this.props.email!=null &&   <Text style={{ fontFamily: 'Piazzolla-Bold', alignSelf: "center" }}>{Lang_chg.phoneotp[config.language]} : {this.props.email}</Text>}
                       <TextInput
                        ...
                        maxLength={4}
                        style={{ fontSize: mobileW * 3.6 / 100,
                        fontFamily:Font.FontMedium,
                        color: Colors.black_color,textAlign:'center', paddingLeft: 10, marginHorizontal: 30, borderWidth: 2, borderColor: Colors.greyColor, borderRadius: 0, marginTop: 10,  height: 40 }}
